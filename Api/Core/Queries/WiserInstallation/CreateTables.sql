...
CREATE TABLE IF NOT EXISTS `wiser_entityproperty`  (
  ...
  `tab_html` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb_general_ci NULL,
  `group_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `inputtype` enum('input','secure-input','textbox','radiobutton','checkbox','combobox','multiselect','numeric-input','file-upload','HTMLeditor','querybuilder','date-time picker','grid','imagecoords','button','image-upload','image-curator','gpslocation','daterange','sub-entities-grid','item-linker','color-picker','auto-increment','linked-item','action-button','data-selector','chart','scheduler','timeline','empty','iframe','mail-editor','page-builder','chartjs','bryntum-calendar','scheduler-timeline', 'checklistbox') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'input',
