        ...
        var kendoGridOptions = $.extend(true, {
            ...
            dataBound: async (event) => {
                ...
                event.sender.tbody.find(".progress").each(function (e) {
                    ...
                    const progressColors = column.progressBarSettings.progressColors.sort(function (a, b) {
                        return b.max - a.max;
                    });
