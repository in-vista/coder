...
namespace Api.Modules.Files.Interfaces
{
    ...
    public interface IFilesService
    {
        ...
        Task<ServiceResult<List<FileModel>>> UploadAsync(string encryptedId, string propertyName, string title, IFormFileCollection files, ClaimsIdentity identity, ulong itemLinkId = 0, bool useTinyPng = false, bool useCloudFlare = false, string entityType = null, int linkType = 0, string cloudFlareUseVariant = null);
