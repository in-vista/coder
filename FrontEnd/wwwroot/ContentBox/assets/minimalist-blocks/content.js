...
var data_basic = {
    'snippets': [
...

		{
		    ...
		    'category': '120',
		    'html': `
			<img src="/ContentBox/assets/minimalist-blocks/images/img-2400x1350.png" alt="">
			`	
		},
        {
		...
		//     'category': '120',
		//     'html': `
		// 	<img src="/ContentBox/assets/minimalist-blocks/images/office2.png" alt="">
		// 	`	
		// },
		// {
		//     'thumbnail': 'preview/basic-21.png',
                    ...
                    data-html="
                            ...
                            <div id="{id}" class="is-media-grid grid-sortable" style="opacity:0">
                              <div class="gallery-item">
                                <a href="/ContentBox/assets/minimalist-blocks/images/img-01.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="/ContentBox/assets/minimalist-blocks/images/img-01.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                              ...
                              <div class="gallery-item">
                                <a href="/ContentBox/assets/minimalist-blocks/images/img-02.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="/ContentBox/assets/minimalist-blocks/images/img-02.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="/ContentBox/assets/minimalist-blocks/images/img-03.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="/ContentBox/assets/minimalist-blocks/images/img-03.jpg" alt="">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="/ContentBox/assets/minimalist-blocks/images/img-04.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="/ContentBox/assets/minimalist-blocks/images/img-04.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="/ContentBox/assets/minimalist-blocks/images/img-06.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="/ContentBox/assets/minimalist-blocks/images/img-06.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="/ContentBox/assets/minimalist-blocks/images/img-05.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="/ContentBox/assets/minimalist-blocks/images/img-05.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="/ContentBox/assets/minimalist-blocks/images/img-07.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="/ContentBox/assets/minimalist-blocks/images/img-07.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="/ContentBox/assets/minimalist-blocks/images/img-08.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="/ContentBox/assets/minimalist-blocks/images/img-08.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="/ContentBox/assets/minimalist-blocks/images/img-09.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="/ContentBox/assets/minimalist-blocks/images/img-09.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
    ...
    "elements": [
		...
		*/
		...
		
		{
		    ...
		    'html': `
			<div class="row">
				<div class="column half"><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x1350.png" alt=""></div>
		    ...
		    'html': `
				<div style="display:flex;width:100%;position:relative;margin:15px 0;background: transparent;">
					<audio controls="" style="width:100%">
						<source src="/ContentBox/assets/minimalist-blocks/example.mp3" type="audio/mpeg">
		...
		},
		{
			...
			<video style="width: 100%;" loop="" autoplay="">
				<source src="/ContentBox/assets/minimalist-blocks/example.mp4" type="video/mp4">
			</video>
			`	
		},
		{
                        ...
                        encodeURIComponent('[' +
                                '{' +
                                    ...
                                    '"images":' +
                                        '[' +
                                            '{' +
                                                '"src": "/ContentBox/assets/minimalist-blocks/images/slide1.jpg", ' +
                                                '"caption": "", "link": "", "width": "450", "align": "", "position": "bottom left"' +
                                            '},' +
                                            '{' +
                                                '"src": "/ContentBox/assets/minimalist-blocks/images/slide2.jpg", ' +
                                                '"caption": "", "link": "", "width": "450", "align": "", "position": "bottom left"' +
                                            '},' +
                                            '{' +
                                                '"src": "/ContentBox/assets/minimalist-blocks/images/slide3.jpg", ' +
                                                '"caption": "", "link": "", "width": "450", "align": "", "position": "bottom left"' +
                                            '}' +
                                        ']' +
                                '}]') + '"' +
									...
									<div data-glide-el="track" class="glide__track">
										<ul class="glide__slides">
											<li class="glide__slide">
												<div data-subblock><img data-image-embed data-noresize data-sync src="/ContentBox/assets/minimalist-blocks/images/travel2.png" alt="" /></div>
											</li>
											<li class="glide__slide">
												<div data-subblock><img data-image-embed data-noresize data-sync src="/ContentBox/assets/minimalist-blocks/images/travel.png" alt="" /></div>
											</li>
										</ul>
									</div>
...

		{
		    ...
		    'html': `
			<div class="row">
				<div class="column half"><img src="/ContentBox/assets/minimalist-blocks/images/img-1200x1600.png" alt=""></div>
				<div class="column half">
					<p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
				</div>
			</div>
		...
		},
		{
			...
			<div class="row relative sm-items-1">
				...
				<div class="flex flex-col justify-center items-center column two-third"><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x1350.png" alt=""></div>
			</div>
			`	
		},
		{
		...
		},
		{
		    ...
		    'html': `
			<div class="row relative sm-items-1">
				<div class="flex flex-col justify-center items-center column two-third" style="width: 100%;"><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x1350.png" alt="" style="width: 99.9136%; height: auto;"></div>
		...
		},
		{
			...
			<div class="row relative sm-items-2">
				<div style="width: 42.6729%; flex: 0 0 auto;" class="column half flex flex-col justify-end pb-3"><img src="/ContentBox/assets/minimalist-blocks/images/img-1200x1600.png" alt="">
				</div>
		...
		},
		{
			...
			<div class="row relative sm-items-1">
				...
				<div class="column half flex flex-col justify-center items-center"><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x1350.png" alt=""></div>
			</div>
			`	
		},
		{
				...
				<div style="position: relative; width: 59%; flex: 0 0 auto;" class="flex flex-col justify-center column half">
					<div class="is-dock">
						<div style="width: 90%;left: 15%;top: 19%;min-width:400px">
							...
							<img alt="" data-noresize="" src="/ContentBox/assets/minimalist-blocks/images/img-2400x1350.png" style="width: 100%; box-shadow: rgba(22, 22, 22, 0.2) 3em 3em 5em;" data-bottom-top="transform: translateX(130px);" data-center-top="transform: translateX(0px);" data-50-top="transform: translateX(0px);" data-top-bottom="transform: translateX(125px);">
						</div>
						<div style="width: 92%;left: 41%;top: 41%;">
							<img alt="" data-noresize="" src="/ContentBox/assets/minimalist-blocks/images/bg2-1920x1080.png" style="width: 100%; box-shadow: rgba(22, 22, 22, 0.2) 3em 3em 5em;" data-bottom-top="transform: translateX(100px);" data-center-top="transform: translateX(0px);" data-50-top="transform: translateX(0px);" data-top-bottom="transform: translateX(100px);">
						</div>
					</div>
				</div>
				...
				<div style="position: relative; min-height: 30vh; width: 59%; flex: 0 0 auto;" class="flex flex-col justify-center items-center column third">
					<div class="is-dock" style="margin:50px 0">
						<div style="width: 120%;left: 40%;top: 4%;">
							<img alt="" data-noresize="" src="/ContentBox/assets/minimalist-blocks/images/img-2400x1350.png" style="width: 100%;" data-bottom-top="transform: translateX(130px);" data-center="transform: translateX(0px);">
						</div>
...
"><i class="icon ion-android-arrow-dropright-circle mr-3 size-50"></i> Show Reel</a>
		...
		/* Photos */
		{
		    ...
		    'html': `
			<div class="row">
				<div class="column half"><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x900.png" alt="" style="margin: 0;float: left;"></div>
				<div class="column half"><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x900.png" alt="" style="margin: 0;float: left;"></div>
			</div>
			`	
		},
		{
		    ...
		    'html': `
			<div class="row">
				<div class="column third"><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x900.png" alt="" style="margin: 0;float: left;"></div>
				<div class="column third"><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x900.png" alt="" style="margin: 0;float: left;"></div>
				<div class="column third"><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x900.png" alt="" style="margin: 0;float: left;"></div>
			</div>
			`	
		...
		},
		{
			...
			<div class="row">
				...
				<div class="column two-third"><img src="/ContentBox/assets/minimalist-blocks/images/img-1920x1280.png" alt=""></div>
			</div>
			`	
		},
		{
		...
		},
		{
			...
			<div class="row">
				<div class="column half">
					<p class="text-center">Example One</p><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x900.png" alt="">
				</div>
				<div class="column half">
					<p class="text-center">Example Two</p><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x900.png" alt="">
				</div>
			</div>
			`	
		},
		...
		},
		{
			...
			<div class="row">
				<div class="column half">
					<img src="/ContentBox/assets/minimalist-blocks/images/img-1350x900.png" alt="">
		...
		},
		{
		    ...
		    'html': `
			<div class="row">
				<div class="column third"><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x900.png" alt="">
		...
		},
		{
		    ...
		    'html': `
			<div class="row">
				<div class="pr-8 column half"><img src="/ContentBox/assets/minimalist-blocks/images/img-1200x1600.png" alt="">
		...
		},
		{
		    ...
		    'html': `
			<div class="row">
				<div style="width: 73.7397%; flex: 0 0 auto;" class="column two-fourth"><img src="/ContentBox/assets/minimalist-blocks/images/img-1600x1200.png" alt=""></div>
		...
		},
		{
			...
			<div class="row sm-autofit md-autofit">
				<div style="width: 38.7637%; flex: 0 0 auto;" class="column fourth"><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x900.png" alt="">
				...
				<div style="width: 100%;" class="column fourth"><img src="/ContentBox/assets/minimalist-blocks/images/img-678x904.png" alt="">

					<h2 class="font-normal size-21">Project Two</h2>
					<p>Lorem Ipsum is simply dummy text of the printing.</p>
				</div>
				<div class="column fourth" style="width: 100%;"><img src="/ContentBox/assets/minimalist-blocks/images/img-678x904.png" alt="">
		...
		/* Profile */
		{
			...
			<div class="row">
				<div class="flex flex-col justify-center items-center column third px-3">
					<div class="img-circular" style="margin:25px 0 0;width: 10vw;height: 10vw;min-width:150px;min-height:150px;"><img style="height: 100%; width: 100%; object-fit: cover" src="/ContentBox/assets/minimalist-blocks/images/img-700x700.png" alt=""></div>
		...
		},
		{
			...
			<div class="row relative sm-items-1">
				...
				<div class="flex flex-col justify-center items-center column two-third">
					<img src="/ContentBox/assets/minimalist-blocks/images/img-1350x1350.png" alt="">
				</div>
			</div>
		</div>
			`	
		},
		{
			...
			<div class="row">
				<div class="column third center flex flex-col justify-start items-center"><img src="/ContentBox/assets/minimalist-blocks/images/img-678x904.png" alt="">
				...
				<div class="column third center flex flex-col justify-start items-center">
					<img src="/ContentBox/assets/minimalist-blocks/images/img-678x904.png" alt="">
		...
		},
		{
			...
			<div class="row">
				<div class="column third py-4"><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x900.png" alt="">
		...
		},
		{
			...
			<div class="row">
				<div class="text-right column third flex flex-col justify-center items-center">
					<div class="img-circular" style="margin:25px 0;width: 13vw;height: 13vw;min-width:150px;min-height:150px;"><img style="height: 100%; width: 100%; object-fit: cover" src="/ContentBox/assets/minimalist-blocks/images/img-700x700.png" alt=""></div>
				</div>
		...
		},
		{
			...
			<div class="row">
				<div class="flex flex-col justify-center items-center px-3 column third py-3">
					<div class="img-circular" style="width: 10vw;height: 10vw;min-width:150px;min-height:150px;"><img style="height: 100%; width: 100%; object-fit: cover" src="/ContentBox/assets/minimalist-blocks/images/img-700x700.png" alt=""></div>
				</div>
		...
		},
		{
			...
			<div class="row">
				<div class="column third"><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x1350.png" alt="">
		...
		},
		{
			...
			<div class="row">
				...
				<div class="column half"><img src="/ContentBox/assets/minimalist-blocks/images/img-1200x675.png" alt=""></div>
			</div>
			`	
		},
		{
		    ...
		    'html': `
			<div class="row">
				<div class="center column half"><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x1350.png" alt=""></div>
		...
		},
		{
		    ...
		    'html': `
			<div class="row">
				<div class="column half flex flex-col justify-end items-start"><img src="/ContentBox/assets/minimalist-blocks/images/img-1200x1600.png" alt=""></div>
		...
		},
		{
		    ...
		    'html': `
			<div class="row relative sm-items-1">
				<div class="flex flex-col justify-center items-center column half" style="width: 58.0263%; flex: 0 0 auto;"><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x1350.png" alt=""></div>
				<div class="py-6 column half" style="width: 100%;">
		...
		/*
		{
			...
			<div class="row relative md-items-2 sm-items-2">
				<div style="width: 27.4233%; flex: 0 0 auto;" class="column fourth pb-4"><img src="/ContentBox/assets/minimalist-blocks/images/img-900x1350.png" alt=""></div>
		...
		*/
		{
			...
			<div class="row relative sm-items-2">
				<div class="column fourth flex flex-col justify-end py-4"><img src="/ContentBox/assets/minimalist-blocks/images/img-900x900.png" alt="">
		...
		},
		{
			...
			<div class="row">
				...
				<div class="column half" style="width: 60.4651%; flex: 0 0 auto;"><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x1350.png" alt=""></div>
			</div>
			<div class="row">
				<div class="column full">
					<div class="spacer height-20"></div>
		...
		},
		{
		    ...
		    'html': `
			<div class="row">
				<div class="column"><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x1350.png" alt=""></div>
		...
		},
		{
			...
			<div class="row">
				...
				<div class="column half"><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x900.png" alt=""></div>
			</div>
			<div class="row">
				<div class="column full">
					<div class="spacer height-40"></div>
		...
		},
		{
		    ...
		    'html': `
			<div class="row">
				<div class="column two-third"><img src="/ContentBox/assets/minimalist-blocks/images/img-1920x1080.png" alt="""></div>
		...
		},
		{
			...
			<div class="row">
				<div class="text-center flex flex-col justify-center items-center column third"><img src="/ContentBox/assets/minimalist-blocks/images/img-700x700.png" alt="" style="border-radius: 500px; width: 65%; height: auto;">
					<div class="spacer height-20"></div>
		...
		},
		{
			...
			<div class="row">
				<div class="text-center flex flex-col justify-center items-center column third"><img src="/ContentBox/assets/minimalist-blocks/images/img-1350x900.png" alt="">
					<div class="spacer height-20"></div>
					<div class="text-center">
						<i class="icon ion-quote size-28"></i>
					</div>
		...
		/* Partners */
		{
			...
			<div class="row sm-autofit">
				...
				<div class="column fourth"><img src="/ContentBox/assets/minimalist-blocks/images/creative.png" alt=""></div>
				<div class="column fourth"><img src="/ContentBox/assets/minimalist-blocks/images/steady.png" alt=""></div>
				<div class="column fourth"><img src="/ContentBox/assets/minimalist-blocks/images/light-studio.png" alt=""></div>
			</div>
			<div class="row">
				<div class="column full">
					<div class="spacer height-20"></div>
			...
			<div class="row sm-autofit">
				...
				<div class="column fourth"><img src="/ContentBox/assets/minimalist-blocks/images/infinitech.png" alt=""></div>
				<div class="column fourth"><img src="/ContentBox/assets/minimalist-blocks/images/design-firm.png" alt=""></div>
				<div class="column fourth"><img src="/ContentBox/assets/minimalist-blocks/images/sitepro.png" alt=""></div>
		...
		},
		{
			...
			<div class="row">
				<div class="column third flex flex-col justify-center items-center">
					<img src="/ContentBox/assets/minimalist-blocks/images/creative.png" alt="">
				</div>
				<div class="column third flex flex-col justify-center items-center">
					<img src="/ContentBox/assets/minimalist-blocks/images/light-studio.png" alt="">
				</div>
				<div class="column third flex flex-col justify-center items-center">
					<img src="/ContentBox/assets/minimalist-blocks/images/infinitech.png" alt="">
				</div>
		...
		},
		{
			...
			<div class="row">
				...
				<div class="column fourth flex flex-col justify-center items-center" style="width: 100%;">
					<img src="/ContentBox/assets/minimalist-blocks/images/infinitech.png" alt="">
					<div class="spacer height-20"></div><img src="/ContentBox/assets/minimalist-blocks/images/light-studio.png" alt="">
				</div>
				<div class="column fourth flex flex-col justify-center items-center" style="width: 100%;">
					<img src="/ContentBox/assets/minimalist-blocks/images/steady.png" alt="">
					<div class="spacer height-20"></div><img src="/ContentBox/assets/minimalist-blocks/images/sitepro.png" alt="">
				</div>
		...
		},
		{
			...
			<div class="row">
				<div class="column fifth"><img src="/ContentBox/assets/minimalist-blocks/images/creative.png" alt=""></div>
				<div class="column fifth"><img src="/ContentBox/assets/minimalist-blocks/images/steady.png" alt=""></div>
				<div class="column fifth"><img src="/ContentBox/assets/minimalist-blocks/images/light-studio.png" alt=""></div>
				<div class="column fifth"><img src="/ContentBox/assets/minimalist-blocks/images/design-firm.png" alt=""></div>
				<div class="column fifth"><img src="/ContentBox/assets/minimalist-blocks/images/sitepro.png" alt=""></div>
		...
		/* As Featured On */
		{
			...
			<div class="row">
				<div class="flex flex-col justify-center items-center column fifth"><img src="/ContentBox/assets/minimalist-blocks/images/upclick.png" alt=""></div>
				<div class="flex flex-col justify-center items-center column fifth"><img src="/ContentBox/assets/minimalist-blocks/images/digitalmag.png" alt=""></div>
				<div class="flex flex-col justify-center items-center column fifth"><img src="/ContentBox/assets/minimalist-blocks/images/mmedia.png" alt=""></div>
				<div class="flex flex-col justify-center items-center column fifth"><img src="/ContentBox/assets/minimalist-blocks/images/bbuzz.png" alt=""></div>
				<div class="flex flex-col justify-center items-center column fifth"><img src="/ContentBox/assets/minimalist-blocks/images/prosource.png" alt=""></div>
		...
		},
		{
			...
			<div class="row">
				...
				<div class="column fifth flex flex-col justify-center items-center"><img src="/ContentBox/assets/minimalist-blocks/images/onesight.png" alt=""></div>
				<div class="column fifth flex flex-col justify-center items-center"><img src="/ContentBox/assets/minimalist-blocks/images/mmedia.png" alt=""></div>
				<div class="column fifth flex flex-col justify-center items-center"><img src="/ContentBox/assets/minimalist-blocks/images/digitalmag.png" alt=""></div>
		...
		},
		{
			...
			<div class="row">
				<div class="column third"><img src="/ContentBox/assets/minimalist-blocks/images/upclick.png" alt=""></div>
				<div class="column third"><img src="/ContentBox/assets/minimalist-blocks/images/digitalmag.png" alt=""></div>
				<div class="column third"><img src="/ContentBox/assets/minimalist-blocks/images/mmedia.png" alt=""></div>
			</div>
			<div class="row">
				<div class="column third"><img src="/ContentBox/assets/minimalist-blocks/images/prosource.png" alt=""></div>
				<div class="column third"><img src="/ContentBox/assets/minimalist-blocks/images/worldwide.png" alt=""></div>
				<div class="column third"><img src="/ContentBox/assets/minimalist-blocks/images/bbuzz.png" alt=""></div>
			</div>
			`	
		},
		{
			...
			<div class="row">
				<div class="flex flex-col justify-center items-center column third"><img src="/ContentBox/assets/minimalist-blocks/images/upclick.png" alt=""></div>
				<div class="flex flex-col justify-center items-center column third"><img src="/ContentBox/assets/minimalist-blocks/images/digitalmag.png" alt=""></div>
				<div class="flex flex-col justify-center items-center column third"><img src="/ContentBox/assets/minimalist-blocks/images/mmedia.png" alt=""></div>

			</div>

			<div class="row">
				<div class="column third flex flex-col justify-center items-center"><img src="/ContentBox/assets/minimalist-blocks/images/prosource.png" alt=""></div>

				<div class="column third flex flex-col justify-center items-center"><img src="/ContentBox/assets/minimalist-blocks/images/nett.png" alt=""></div>
				<div class="column third flex flex-col justify-center items-center"><img src="/ContentBox/assets/minimalist-blocks/images/worldwide.png" alt=""></div>
		...
		},
		{
			...
			<div class="row">
				<div class="column full"><img src="/ContentBox/assets/minimalist-blocks/images/img-1600x600.png" alt=""></div>
			</div>
			<div class="row">
		...
		/*  About */
		{
			...
			<div class="row">
                ...
                <div class="row">
                    <div class="column third"><img src="/ContentBox/assets/minimalist-blocks/images/sitepro.png" alt="" style="margin: 0;"></div>
                    <div class="column two-third">
		...
		
		{
			...
			<div class="row">
				...
				<div class="column third"><img src="/ContentBox/assets/minimalist-blocks/images/img-1200x1600.png" alt=""></div>
				<div class="column third"><img src="/ContentBox/assets/minimalist-blocks/images/img-1200x1600.png" alt=""></div>
		...
		
		{
			...
			<div class="row">
				<div class="column half"><img src="/ContentBox/assets/minimalist-blocks/images/img-1920x1080.png" alt=""></div>
				<div class="column half">
					<p class="text-justify">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type.</p>
				</div>
		...
		'html':
			    '<div class="row">' +
                    '<div class="column full" data-noedit data-module="my-ajax-module" data-dialog-width="500px" data-module-desc="Sample Ajax Request Module" data-html="' + // module file will be: assets/modules/my-ajax-module.html
                        ...
                        '<scr' + 'ipt>' +
                            ...
                            'docReady(function () {' +
                                ...
                                'xmlhttp.onreadystatechange = function() {' +
                                    ...
                                    '}' +
                                '};' +
                                'xmlhttp.open("GET", "/ContentBox/assets/sampledata.txt", true);' +
                                'xmlhttp.send();' +
                                '' +
                            '});' +
                        '</scr' + 'ipt>' +
                        ...
                        '" data-settings="' +
                        // Default Settings (Custom Variables)
                        encodeURIComponent('{"title": "Sample Content From Ajax Request", "requestUrl": "/ContentBox/assets/sampledata.txt"}') + '"' +
