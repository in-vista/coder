export class ModuleSettingsModel {
    constructor(id = -1, customQuery = null, countQuery = null, pendingActionsQuery = null, options = null, name = null, icon = null, type = null, group = null) {
        this.id = id;
        this.customQuery = customQuery;
        this.countQuery = countQuery;
        this.pendingActionsQuery = pendingActionsQuery;
