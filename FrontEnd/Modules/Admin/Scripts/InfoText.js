export class InfoText {
    ...
    getTranslations() {
        return [
            ...
            { name: "defaultOrdering", text: "De manier waarop items gesorteerd moeten worden in de boom (tree view). Let op; indien dit ingesteld staat op 'naam', dan kan de volgorde van items niet meer handmatig aangepast worden in Coder." },
            { name: "friendlyName", text: "De naam van dit entiteitstype zoals die aan de gebruiker getoond moet worden." },
            { name: "entityDedicatedTablePrefix", text: "Items van Coder kunnen in verschillende tabellen worden opgeslagen. Standaard worden all items opgeslagen in wiser_item en wiser_itemdetail, behalve wanneer hier een voorvoegsel is ingevuld. Dan worden items van dit type opgeslagen in [voorvoegsel]_wiser_item en [voorvoegsel]_wiser_itemdetail." },
            { name: "searchQuery", text: "Dit wordt gebruikt bij velden van het type sub-entities-grid. Bij die velden kan een knop toegevoegd worden welke een popup opent waarin gezocht kan worden naar items om te koppelen. De query daarvoor kan hier gevuld worden. Zie Coder documentatie voor meer informatie." },
            ...
            { name: "aggregateOptions", text: "Extra aggregatie-instellingen. Zie Coder documentatie voor meer informatie." },
            ...
            { name: "enableMultipleEnvironments", text: "Met deze optie aan, kunnen er meerdere versies van items met dit entiteitstype bestaan. Items van dit type krijgen dan een extra optie in Coder om die op te slaan naar een bepaalde omgeving (ontwikkeling, test, acceptatie en live). Hier worden dan aparte regels voor aangemaakt in de database en die worden aan elkaar gekoppeld dmv de kolom 'original_item_id'." },
            { name: "visibilityPathRegex", text: "Hiermee kan een regex ingesteld worden die uitgevoerd wordt op het volledige pad van het item, wanneer die geopend wordt in Coder via een boom (tree view). Dit pad is de naam van alle bovenliggende items achter elkaar geplakt met slashes ertussen, bijvoorbeeld '/Eten & Drinken/Frisdranken/Cola/'. Indien de regex succesvol valideert op dit pad, wordt dit veld getoond, anders verborgen." },
            ...
            { name: "multiSelectImagePropertyName", text: "De waarde van de kolom property_name van wiser_itemfile van de afbeelding die per optie getoond moet worden. De dataSource moet dan een property 'id' bevatten van het item waar deze afbeelding opgeslagen staat. Deze optie hoeft niet ingevuld worden als de dataSource al een eigenschap 'imagePropertyName' heeft, of als afbeeldingen op een andere manier uit de dataSource komen. Voor meer informatie, zie de documentatie van Coder over multiSelect." },
            { name: "optionsJson", text: "Dit is een JSON object met alle overige opties, waar geen losse velden voor staan. Vrijwel alle velden in Coder zijn componenten van Kendo UI, alle opties die Kendo heeft, kunnen hier ingevuld worden. Zie de documentatie van Kendo UI voor alle beschikbare opties." },
